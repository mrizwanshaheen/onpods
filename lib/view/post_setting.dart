      ...
      child: SingleChildScrollView(
        ...
        child: Container(
          ...
          child: Container(
            ...
            padding: EdgeInsets.fromLTRB(11 * fem, 16 * fem, 20 * fem, 0 * fem),
            width: double.infinity,
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  margin:
                      EdgeInsets.fromLTRB(2 * fem, 0 * fem, 0 * fem, 22 * fem),
                ...
                Container(
                  ...
                  margin:
                      EdgeInsets.fromLTRB(0 * fem, 0 * fem, 2 * fem, 101 * fem),
                  padding:
                      EdgeInsets.fromLTRB(0 * fem, 11 * fem, 0 * fem, 14 * fem),
                  width: 397 * fem,
                  decoration: BoxDecoration(
                    color: Color(0xff19232f),
                    borderRadius: BorderRadius.circular(8 * fem),
                ...
                Container(
                  ...
                  margin:
                      EdgeInsets.fromLTRB(11 * fem, 0 * fem, 2 * fem, 40 * fem),
                  width: double.infinity,
                  child: Row(
                ...
                Container(
                  ...
                  margin:
                      EdgeInsets.fromLTRB(11 * fem, 0 * fem, 2 * fem, 20 * fem),
                  width: double.infinity,
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                ...
                Container(
                  ...
                  margin:
                      EdgeInsets.fromLTRB(11 * fem, 0 * fem, 5 * fem, 36 * fem),
                  width: double.infinity,
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.end,
                    children: [
                ...
                Container(
                  ...
                  margin:
                      EdgeInsets.fromLTRB(381 * fem, 0 * fem, 0 * fem, 0 * fem),
                  width: 14 * fem,
                  height: 14 * fem,
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(7 * fem),
                ...
                Container(
                  ...
                  margin:
                      EdgeInsets.fromLTRB(55 * fem, 0 * fem, 31 * fem, 0 * fem),
                  width: double.infinity,
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
