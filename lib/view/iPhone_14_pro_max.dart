            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        height: 49 * fem,
                        child: Image.asset(
                          'assets/final/images/untitled-1-3-9mA.png',
                        ),
                      ),
                      Container(
                        ...
                        height: 19 * fem,
                        child: Image.asset(
                          'assets/final/images/untitled-1-1-es2.png',
                        ),
                      ),
                    ],
                  ),
                ...
                Container(
                  ...
                  margin:
                      EdgeInsets.fromLTRB(2 * fem, 0 * fem, 0 * fem, 90 * fem),
                  child: Text(
                    'CREATE ROOM',
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.cover,
                      image: AssetImage(
                        'assets/final/images/ellipse-52-bg.png',
                      ),
                    ),
                  ),
                ),
                Container(
                  // privateioJ (94:2307)
                  margin:
                      EdgeInsets.fromLTRB(0 * fem, 0 * fem, 1 * fem, 12 * fem),
                  child: Text(
                    'PRIVATE',
                    style: SafeGoogleFont(
                      'Roboto',
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.cover,
                      image: AssetImage(
                        'assets/final/images/ellipse-53-bg.png',
                      ),
                    ),
                  ),
                ),
